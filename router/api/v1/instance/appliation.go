...
type Application struct {
	...
	Links      map[string]string `json:"links,omitempty"  description:"link map of the release,key:chart_name,value:release_name"`
	Chart      string            `json:"chart,omitempty"  description:"chart info"`
