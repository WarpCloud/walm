...
// 2018-08-01 20:18:58.286868871 +0800 CST m=+0.083036899
...
var doc = `{
    ...
    "paths": {
        "/chart/{chartname}/version/{chartversion}/validation": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "chart name, eg: stable/mysql",
                        "name": "chartname",
                        "in": "path",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "chart version, default latest version, eg: 5.2.0",
                        "name": "chartversion",
                        "in": "path"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "object",
                            "$ref": "#/definitions/helm.ChartValicationInfo"
                        }
                    },
                    "400": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/node.NodeLabelsInfo"
                            }
                        }
                    },
                    "400": {
                        "description": "Invalid NodeName supplied!",
                        "schema": {
                            "type": "object",
                            "$ref": "#/definitions/ex.ApiResponse"
                        }
