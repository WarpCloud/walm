...
import (
	...
	time "time"
	transwarp_v1beta1 "transwarp/release-config/pkg/apis/transwarp/v1beta1"
...
// NewReleaseConfigInformer constructs a new informer for ReleaseConfig type.
...
// NewFilteredReleaseConfigInformer constructs a new informer for ReleaseConfig type.
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
func NewFilteredReleaseConfigInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(
		...
		&transwarp_v1beta1.ReleaseConfig{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *releaseConfigInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&transwarp_v1beta1.ReleaseConfig{}, f.defaultInformer)
}
