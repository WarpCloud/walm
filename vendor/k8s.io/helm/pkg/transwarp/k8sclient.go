...
func GetTranswarpKubeClient(kubeConfig string) (*clientsetex.Clientset, error) {
	...
	if DefaultApiserverClientEx != nil {
		return  DefaultApiserverClientEx, nil
	}
	...
	DefaultApiserverClientEx, err = clientsetex.NewForConfig(cfg)
	if err != nil {
		return nil, err
	}
...
func GetK8sKubeClient(kubeConfig string) (*kubernetes.Clientset, error) {
	...
	if DefaultApiserverClient != nil {
		return  DefaultApiserverClient, nil
	}
	...
	DefaultApiserverClient, err = kubernetes.NewForConfig(cfg)
	if err != nil {
		return nil, err
	}
	...
	err = wait.ExponentialBackoff(defaultRetry, func() (bool, error) {
		v, err = DefaultApiserverClient.Discovery().ServerVersion()
